...
export default function Home() {
  ...
  const advantages = [
    { icon: Factory, title: 'In-house Resin Production', description: 'Consistent quality control' },
    { icon: Leaf, title: 'Solar-Powered Operations', description: 'Reducing environmental footprint' },
    { icon: Award, title: 'Premium Raw Materials', description: 'Sourced from China, Indonesia, Burma, and Laos' },
    { icon: CheckCircle, title: 'Rigorous Quality Checks', description: 'Flexibility in sizes for customer needs' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
                ...
                <Image src="8.jpeg" alt="Amarjyoti Ply" width={200} height={200} />
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#manufacturing" className="text-gray-700 hover:text-gray-900 transition-colors font-medium">Manufacturing</a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200">
              <div className="flex flex-col space-y-3">
                <a href="#about" className="text-gray-700 hover:text-gray-900 transition-colors px-2 py-1 font-medium">About</a>
                <a href="#products" className="text-gray-700 hover:text-gray-900 transition-colors px-2 py-1 font-medium">Products</a>
                <a href="#manufacturing" className="text-gray-700 hover:text-gray-900 transition-colors px-2 py-1 font-medium">Manufacturing</a>
                <a href="#contact" className="text-gray-700 hover:text-gray-900 transition-colors px-2 py-1 font-medium">Contact</a>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-100 max-w-3xl mx-auto mb-12 leading-relaxed drop-shadow-md">
              A proud legacy since the 1990s, delivering premium plywood solutions with unwavering commitment to quality, 
              sustainability, and customer satisfaction. From timber trading to manufacturing excellence.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#contact">
                <Button size="lg" className="bg-gradient-to-r from-gray-800 to-slate-800 hover:from-gray-900 hover:to-slate-900 text-white px-8 py-3 shadow-lg">
                  <Phone className="w-5 h-5 mr-2"  />
                  Contact Us
                </Button>
              </a>
              <a href="#products">
                <Button variant="outline" size="lg" className="border-gray-700 text-gray-700 hover:bg-gray-50 px-8 py-3">
                  View Products
                </Button>
              </a>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">30+</div>
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">200+</div>
      ...
      {/* About Section */}
      <section id="about" className="py-20 scroll-mt-24 bg-gradient-to-br from-gray-50 to-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Shri Om Plywood Pvt. Ltd. carries a proud legacy that began with timber trading. Founded by our grandfather, 
                father, and uncle, the company laid its foundation in the early 1990s with a focus on supplying quality timber 
                to the plywood industry.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                In 1995, we expanded into plywood manufacturing, turning our experience and vision into a trusted brand. 
                From the very beginning, our guiding principle has been simple yet powerful: we deliver what we promise.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                We never over-commit and under-deliver, a value that has earned us the trust of clients who have stayed 
              ...
              <Card className="border-gray-200 hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-700">
                    To build a proudly Made in India plywood brand that is accessible to all - delivering high performance, 
              ...
              <Card className="border-gray-200 hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>• Build long-term customer relationships through transparency</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Premium quality products crafted with precision and care, designed to meet diverse construction and furniture needs.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {products.map((product, index) => (
              <Card key={index} className="border-gray-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {product.sizes.map((size, idx) => (
                          <Badge key={idx} variant="outline" className="border-amber-300 text-amber-700 bg-amber-50 hover:bg-amber-100">
                            {size}
                          </Badge>
                        ))}
                      </div>
      ...
      <section id="manufacturing" className="py-20 scroll-mt-30 bg-gradient-to-br from-gray-50 to-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Manufacturing & Sustainability</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-gray-800 to-slate-800 mx-auto mb-6"></div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                We have grown from humble beginnings to a large-scale operation. From dispatching just 10 trucks a month, 
                we now scale to over 50 trucks every month, reflecting the trust and demand our products have earned.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Our strength is powered by a dedicated core team of 30+ employees along with 200+ skilled personnel, 
                ensuring smooth operations from manufacturing to delivery.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-gray-800 to-slate-800 mx-auto mb-6"></div>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Trusted by OEMs and dealers across India for our commitment to quality, reliability, and customer satisfaction.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Get in touch with us for all your plywood needs. We're here to help you find the perfect solution.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <Card className="border-gray-200">
                ...
                <CardContent>
                  <p className="text-gray-700">
                    Room 201, Vardhman Plaza Corner<br />
              ...
              <Card className="border-gray-200">
                ...
                <CardContent>
                  <div className="space-y-2">
                    <a href="tel:+919716192739" className="flex items-center text-gray-700 hover:text-gray-900 transition-colors">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-slate-800 rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-200 mb-8 leading-relaxed">
                Whether you're an OEM, dealer, or individual customer, we're committed to delivering exactly what we promise. 
                Contact us today to discuss your plywood requirements.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-200">Timely Delivery Guaranteed</span>
                </div>
                <div className="flex items-center space-x-3">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <Image src="7.jpeg" alt="Amarjyoti Ply" width={150} height={150} />
                <div>
                  <h3 className="text-lg font-bold">Shri Om Plywood Pvt. Ltd.</h3>
                  <p className="text-sm text-amber-400">Amarjyoti Ply - Ply Jo Amar Rahe</p>
                </div>
              </div>
              <p className="text-gray-400 leading-relaxed">
                A legacy of trust and quality since the 1990s, delivering premium plywood solutions across India.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <a href="#manufacturing" className="block text-gray-400 hover:text-white transition-colors">Manufacturing</a>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-gray-400">
                    ...
                    <p className="text-sm">48 Km Stone, Village Sampla, Haryana - 124501</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-gray-400">
                    ...
                    <p className="text-sm">Room 201, Vardhman Plaza Corner, Peeragarhi, Delhi - 110041</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="text-center text-gray-400">
            <p>&copy; 2025 Amarjyoti Ply - Ply Jo Amar Rahe. All rights reserved.</p>
            <p className="text-sm mt-2">Delivering what we promise - Never over-commit, never under-deliver</p>
